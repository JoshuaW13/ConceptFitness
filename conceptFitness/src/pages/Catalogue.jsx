  ...
  return (
    <div className="w-full h-full flex flex-col items-center relative">
      ...
      <div className="flex flex-row justify-end w-full">
        ...
        <button onClick={toggleDrawer} className={`w-7 h-14 -left-7  top-1/2 bg-blue-500 text-white p-0 rounded`}>
          {isDrawerOpen ? 'c' : 'o'}
        </button>

        {/* Right Drawer */}
        <div
          className={`h-full w-[90%] bg-blue-500 top-0 right-0 transform ${
            isDrawerOpen ? 'translate-x-0 visible' : 'translate-x-[50%] scale-x-0 hidden'
