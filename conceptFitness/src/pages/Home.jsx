        ...
        <div className='flex flex-col m-4 w-[90%] gap-4 flex-grow'>
          <div className='flex flex-row gap-2 flex-grow'>
            <div className='flex flex-col w-[50%] gap-4 h-full '>
              <button className='bg-[#EAE7DC] text-[#E85A4F] text-xl flex items-center justify-center p-3 border-4 border-[#D8C3A5] rounded-2xl font-bold flex-grow'
            ...
            <div className='w-[80%] bg-[#eeede8] rounded-2xl flex-grow text-l font-bold border-4 border-[#D8C3A5] text-white'>
              <p className='pt-1 font-semibold text-lg text-[#E85A4F]'>Goals</p>
            </div>
          </div>
          <button className='button text-xl h-[15%] rounded-2xl border-4 border-bg-[#D8C3A5]'
